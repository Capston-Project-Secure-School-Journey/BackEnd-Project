...
public interface IJourneyNoteHandler
{
    ...
    Task<Pagination<JourneyNote>> GetAllJourneyNotesByDriver(GetJourneyNoteRequest request, Guid driverId);
    Task<Pagination<JourneyNote>> GetAllJourneyNotesByParent(GetJourneyNoteRequest request, Guid parentId);
