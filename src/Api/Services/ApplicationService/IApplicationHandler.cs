...
{
    Task<List<ApplicationResponse>> GetApplicationsBySchool(Guid schoolId, GetDriverApprovalApplication request);
    Task<List<ApplicationResponse>> GetApplicationsByDriver(Guid driverId, GetDriverApprovalApplication request);
