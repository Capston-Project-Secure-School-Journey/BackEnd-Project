...
namespace Api.Attributes
{
    ...
    public class CheckVerifedEmailAttribute() : Attribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            try
            {
                var checker = context.HttpContext.RequestServices.GetService<IVerifedEmailChecker>();
    ...
    public interface IVerifedEmailChecker
    {
        void Check(AuthorizationFilterContext context);
    }

    public class VerifedEmailChecker : IVerifedEmailChecker
    {
        public VerifedEmailChecker()
        {
        }
