...
namespace Api.Migrations
{
    ...
    [Migration("20250601040437_update_db_2025_06_01")]
    partial class update_db_2025_06_01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Models.ActiveDriver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<sbyte>("SeatingCapacity")
                        .HasColumnType("tinyint")
                        .HasColumnName("seating_capacity");

                    b.Property<long>("TotalDistanceKm")
                    ...
                    b.HasIndex("DriverId", "SchoolId");

                    b.ToTable("active_drivers", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Domain.Models.ScheduleGroup", b =>
                {
                    ...
                    b.Property<string>("ClassException")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("schedule_groups", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Domain.Models.Student", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTimeUpdatedPickupLocation")
                        .HasColumnType("datetime")
            ...
            modelBuilder.Entity("Api.Domain.Models.User", b =>
                {
                    ...
                    b.Property<sbyte?>("VerificationMethod")
                        .HasColumnType("tinyint")
            ...
            modelBuilder.Entity("Api.Domain.Models.ActiveDriver", b =>
                {
                    b.HasOne("Api.Domain.Models.Driver", "Driver")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Domain.Models.ClassSchedule", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Models.ScheduleGroup", "ScheduleGroup")
            ...
            modelBuilder.Entity("Api.Domain.Models.DriverApprovalRequest", b =>
                {
                    b.HasOne("Api.Domain.Models.Driver", "Driver")
                        .WithMany("DriverApprovalRequests")
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Api.Domain.Models.Driver", b =>
                {
                    b.Navigation("DriverApprovalRequests");
                });
